...
export const RegisterWrapper = ({ onChangeMode }: RegisterWrapperProps) => {
    ...
    <View className="w-full items-center">
      <View className="w-full max-w-md rounded-3xl bg-main/85 border border-white/10 px-5 py-6 shadow-lg">
        ...
        <Text className="text-off-white/60 text-sm mt-1 mb-6">
          Cadastre-se para encontrar sua próxima morada
        </Text>
          ...
          <View className="gap-2">
            ...
            <TextInput
              ...
              className={`
                ...
                ${nameFocused ? "border-warm-yellow" : "border-white/10"}
              `}
            />
          </View>
